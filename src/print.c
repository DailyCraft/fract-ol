...
/*   Updated: 2024/12/05 15:44:08 by dvan-hum         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	ft_printf("\e[1;32mWelcome the the dvan-hum's fract-ol project!\e[0m\n\n");
	...
	ft_printf("\e[34mCursor scroll:\e[0m zoom-in / zoom-out\n");
	ft_printf("\e[34mArrows:\e[0m move the view\n");
	ft_printf("\e[34mC key:\e[0m change color\n");
	ft_printf("\e[34mR key:\e[0m reset scale and position\n");
	ft_printf("\e[34mD key:\e[0m shpw debug info\n");
}
...
void	print_julia_help(char *prog)
{
	...
	ft_printf("\e[1;33m---------- Some values suggestions for c ");
	ft_printf("----------\e[0m\n");
...
void	print_burning_ship_help(char *prog)
{
	...
	ft_printf("\e[36m%s j [{Re(c)} {Im(c)}]\e[0m\n\n", prog);
	ft_printf("No c values can be provided, in this case, the Mandelbrot\n");

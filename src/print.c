...
/*   Updated: 2024/12/06 14:05:03 by dvan-hum         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	explain_re_im(void)
{
	ft_printf("\nRe(c) and Im(c) are respectively the real and imaginary ");
	ft_printf("parts of the complex number c.\n");
	ft_printf("So, for c = a + ib, with a and b being real numbers, ");
	ft_printf("Re(c) = a and Im(c) = b\n");
	ft_printf("For example, if c = -0.8 + 0.1i, ");
	ft_printf("Re(c) = -0.8 and Im(c) = 0.1\n");
}
